...
config = {}
config["train_corpus_path"] = "./TianMadata/train.txt"
config["test_corpus_path"] = "./TianMadata/test.txt"
config["word2idx_path"] = "./TianMadata/wiki_dataset/bert_word2idx_extend.json"
